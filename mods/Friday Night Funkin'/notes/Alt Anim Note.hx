...
function onPlayerHit(direction) {
    switch(direction) {
        case 0: //SING LEFT
            PlayState.boyfriend.playAnim("singLEFT-alt", true);
        case 1: //SING DOWN
            PlayState.boyfriend.playAnim("singDOWN-alt", true);
        case 2: //SING UP
            PlayState.boyfriend.playAnim("singUP-alt", true);
        case 3: //SING RIGHT
            PlayState.boyfriend.playAnim("singRIGHT-alt", true);
    }
}
